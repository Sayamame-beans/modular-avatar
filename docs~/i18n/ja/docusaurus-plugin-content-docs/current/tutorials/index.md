...
* [簡単な衣装のセットアップ](/docs/tutorials/clothing/) - 多くの場合は衣装を数クリックだけでセットアップできます。このチュートリアルで詳細をチェック！
* [複雑なCloth衣装のセットアップ](/docs/tutorials/adv_clothing/) - もう少しだけセットアップが必要になる、複雑な衣装の例です。
